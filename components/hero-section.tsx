    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-10 md:pt-14">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto">
        ...
        >
          <button
            onClick={onDiscover}
           className="group relative px-10 py-4 text-base font-semibold tracking-wider uppercase bg-[#f5f5f0] text-[#1a1a2e] rounded-full transition-all duration-500 hover:shadow-[0_0_50px_rgba(0,220,255,0.5)] hover:scale-105 border border-cyan-300/70 shadow-[0_0_28px_rgba(0,220,255,0.45)]"
            style={{
